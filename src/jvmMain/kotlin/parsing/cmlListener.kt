...
interface cmlListener : ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by the `raceDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun enterRaceDesc(ctx: RaceDescContext?)

    /**
     * Exit a parse tree produced by the `raceDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun exitRaceDesc(ctx: RaceDescContext?)

    /**
     * Enter a parse tree produced by the `classDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun enterClassDesc(ctx: ClassDescContext?)

    /**
     * Exit a parse tree produced by the `classDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun exitClassDesc(ctx: ClassDescContext?)

    /**
     * Enter a parse tree produced by the `bgDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun enterBgDesc(ctx: BgDescContext?)

    /**
     * Exit a parse tree produced by the `bgDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun exitBgDesc(ctx: BgDescContext?)

    /**
     * Enter a parse tree produced by the `itemDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun enterItemDesc(ctx: ItemDescContext?)

    /**
     * Exit a parse tree produced by the `itemDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun exitItemDesc(ctx: ItemDescContext?)

    /**
     * Enter a parse tree produced by the `spellDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun enterSpellDesc(ctx: SpellDescContext?)

    /**
     * Exit a parse tree produced by the `spellDesc`
     * labeled alternative in [cmlParser.topLevel].
     * @param ctx the parse tree
     */
    fun exitSpellDesc(ctx: SpellDescContext?)
    ...
    /**
     * Enter a parse tree produced by the `callExprNoArgs`
     * labeled alternative in [cmlParser.stmt].
     * @param ctx the parse tree
     */
    fun enterCallExprNoArgs(ctx: CallExprNoArgsContext?)

    /**
     * Exit a parse tree produced by the `callExprNoArgs`
     * labeled alternative in [cmlParser.stmt].
     * @param ctx the parse tree
     */
    fun exitCallExprNoArgs(ctx: CallExprNoArgsContext?)
